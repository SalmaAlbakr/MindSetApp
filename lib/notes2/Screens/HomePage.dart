...
import 'package:next_poject/notes2/Screens/AddNotePage.dart';
import 'package:next_poject/notes2/Screens/ShowNotePage.dart';
                  ...
                  ValueListenableBuilder(
                    ...
                    builder: (_, Box box, __) {
                      ...
                      if (box.values.isEmpty) {
                        return Center(
                          child:
                              TextFrave(text: 'No notes', color: Colors.grey),
                        );
                      }
      ...
      itemBuilder: (_, i) {
        ...
        return GestureDetector(
          ...
          child: Dismissible(
            ...
            onDismissed: (direction) => noteBloc.add(
              DeleteNoteEvent(i),
            ),
            child: Container(
