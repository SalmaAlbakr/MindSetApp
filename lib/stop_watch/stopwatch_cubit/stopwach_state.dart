...
class StartWatchState extends StopwachState {
  ...
  StartWatchState(this.isVisible, this.isNotVisible, this.stopIsPressed, this.startIsPressed);
...
class StopwatchState extends StopwachState {
  ...
  StopwatchState(this.isVisible, this.isNotVisible, this.stopIsPressed, this.resetIsPressed);
}
class ResetWatchState extends StopwachState {
  final resetIsPressed;
  final startIsPressed;

  ResetWatchState(this.resetIsPressed, this.startIsPressed);
